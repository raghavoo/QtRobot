...
from QtRobot import dispatcher, function
from QtRobot.utils.can_restrict import BAN_STICKER
from QtRobot.plugins.disable import DisableAbleCommandHandler
from QtRobot.plugins.helper_funcs.chat_status import check_admin, is_user_admin
from QtRobot.plugins.helper_funcs.extraction import (
    extract_text,
    extract_user,
    extract_user_and_text,
)
from QtRobot.plugins.helper_funcs.misc import split_message
from QtRobot.plugins.helper_funcs.string_handling import split_quotes
