...
# ➥ @QtRobotbot ʏᴏᴜʀ ᴍᴇssᴀɢᴇ @ᴜsᴇʀɴᴀᴍᴇ
# ➥ @QtRobotbot @ᴜsᴇʀɴᴀᴍᴇ ʏᴏᴜʀ ᴍᴇssᴀɢᴇ
...
from QtRobot import DB_NAME, MONGO_DB_URI, function
...
» @QtRobotbot your message @username
» @QtRobotbot @username your message
"""
